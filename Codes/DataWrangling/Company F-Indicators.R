...
#-----Net Income-----#
  ...
  NetIncome <- data.frame(NetIncome[,c(1,2,3,4,5,6,9)],
  ...
  NetIncome_KR[,c(2:11)] <-sapply(NetIncome_KR[,c(2:11)], 
                                function (x) {
                                  as.double(
                                    gsub(",","",as.character(x))
                                  )
...
#-----Year End Assets-----#
  ...
  YearEndAssets[,c(2:11)] <-sapply(YearEndAssets[,c(2:11)], 
                                 function (x) {
...
#-----Operating Cash Flow-----#
  ...
  OperatingCashFlow_KR[,c(2:11)] <- sapply(OperatingCashFlow_KR[,c(2:11)], 
                                         function (x) {
                                           as.double(gsub(",","",as.character(x))
                                                    )
                                         }
