...
write.csv(ga_Volume_Average_Low_NaN,"C:\\Users\\Tse Young\\Desktop\\Data Science research\\F-score\\Company List\\Company_Volume_Low_Trades.csv")
write.csv(ga_Volume_Average,"C:\\Users\\Tse Young\\Desktop\\Data Science research\\F-score\\Company List\\Company_Volume_Trades.csv")
...
Fiscal_Month_Modified <- Fiscal_Month
...
Total_MCAP
SP_Average_MCAP
write.csv(SP_Average_MCAP,"C:\\Users\\Tse Young\\Desktop\\Data Science research\\F-score\\Company List\\Company_Weight_Cap.csv")
...
head(PE_KR_Gather)
filter(PE_KR_Gather,Symbol=="MSFT")

write.csv(PE_KR_Gather,"C:\\Users\\Tse Young\\Desktop\\Data Science research\\F-score\\Company List\\Company_PE_Ratio.csv")
...
head(PE_Ratio)
PE_Ratio
write.csv(PE_Ratio,"C:\\Users\\Tse Young\\Desktop\\Data Science research\\F-score\\Company List\\Company_PE_Ratio_Modified.csv")
